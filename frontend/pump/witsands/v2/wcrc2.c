...
int refresh;
	...
	txpos = 373;
	display_level( txpos    , 225       ,  7, 84, 146, 14, val_con(41, 821), 't');
	...
	txpos -= 95;
	display_level( txpos    , 225       ,  7, 84, 146, 14, val_con(40, 821), 't');
	txpos -= 95;
	display_level( txpos    , 225       ,  7, 84, 146, 14, val_con(39, 821), 't');
	display_level ( 365     , 356       ,  7, 90, 146, 14, val_con(42, 821), 't');
	...
	display_level ( xpos-1  ,  99+88    , 70, 86, 767,  2, val_con(48, 1023), 'l');
	if( Waardes[91] <0)
		Waardes[91] = 0;
	display_level ( xpos-52 , 333       , 72, 88, 682,  3, val_con(91, 1023), 'l');
	...
	if( Waardes[46] > 329)
		Waardes[46] = 329;
	display_level ( 407     , (MaxY-21) ,169, 92, 297, 4, val_con(46, 340), 'l');
	barv_length =(float) 4/329;
	barv_length *= Waardes[46];
	sprintf ( date_buf, "%4.2f m", barv_length);
	Outtextxy (  455 , (MaxY-70) , date_buf, 6);
	display_level ( xpos-308, (MaxY-46) , 59, 79, 443,  3, val_con(45, 1024), 'l');
