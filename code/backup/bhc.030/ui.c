...
#define	LCD_W		0x1000		/* Wait period for remote LCD	*/
...
//#define	DB ((sample*) 0x28000L )	/* Database XDATA location	*/
sample	DB[DB_SIZE];
...
//	printf("Press: %03bu ", p_ave);	/* Print ADC pressure		*/
//	calc_level( );			/* Refresh Water Level Variable	*/
//	printf("Level: %03.1f ",
//		(float) water_level/10);/* Print water level		*/
