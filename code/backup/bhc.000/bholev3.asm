...
ORG 5BH
        ...
        CLR C
        MOV A,R6
        SUBB A,#20        ;ENABLE ADC EVERY SEC
        JC NEXT
...
NEXT:   NOP
        ...
        CLR C
        MOV A,R7
        SUBB A,#200        ;ENABLE CLOCK ROUTINE EVERY 10 SEC
        JC NEXT1
...
NEXT1:  NOP
        ...
        MOV A,R5
        SUBB A,#100
        JC NEXT2           ;ENABLE FLOW CONTROL EVERY 5 SEC
...
WAIT10: NOP
      ...
      ;******************************************************
        ...
        LCALL SUB1
LAB1E:  NOP
        NOP               ;ANALOG CONVERSION SUBROUTINE ENABLE
        NOP       
LAB2E:  NOP
