...
#define	S_STO		1		/* Signal: Stop Control Engine	*/
#define	S_STA		2		/* Signal: Start Control Engine	*/
#define	S_RLL		3		/* Signal: Reset Low Level Lock	*/
#define	S_PT		4		/* Signal: Toggle Power LED	*/
#define	S_RF		5		/* Signal: Reset Total Flow	*/
...
extern	byte	flow;			/* Latest Flow Rate Calculation	*/
