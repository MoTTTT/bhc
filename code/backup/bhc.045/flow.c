...
uint	idata t_cos=	F_ZERO;		/* Number of samples since COS	*/
ulong	idata f_tot;			/* Flow total			*/
ulong	idata t_last;			/* Time at last flow interrupt	*/
ulong	idata t_litre;			/* Time for last litre		*/
byte	idata flow;			/* Public Flow variable		*/
//byte	idata f_dl;			/* Flow (in decilitres= 0.1 l)	*/
...
//	f_dl=	10000/ t_litre;		/* Convert litre period to dl	*/
}
