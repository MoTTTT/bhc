...
byte idata pf_tot=	0;		/* Phase fail sample successes	*/
byte idata pf_cnt=	0;		/* Number of samples taken	*/
byte idata o_tot=	0;		/* Overload sample successes	*/
byte idata o_cnt=	0;		/* Number of samples taken	*/
