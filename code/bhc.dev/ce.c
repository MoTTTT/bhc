...
/* 12:13 29/06/1998 	Removed Valve Control ( Temporarily )		*/
/* 									*/
...
#include	<ce.h>			/* Public Control Engine Include*/
...
#define	PRE_1MS		7		/* Timer Interrupts per ms	*/
...
{
	TH0=	T_RH;			/* Reload timer for F ~= 9 kHz	*/
	flow_poll( );			/* Check for flow pulse		*/
	s_rxh	( );			/* Serial RX frame handler	*/
